...
const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="1200" height="630" viewBox="0 0 1200 630">
  <defs>
    <radialGradient id="glow" cx="22%" cy="42%" r="55%">
      <stop offset="0%" stop-color="#FF4E00" stop-opacity="0.20"/>
      <stop offset="100%" stop-color="#FF4E00" stop-opacity="0"/>
    </radialGradient>
  </defs>
  <rect width="1200" height="630" fill="#001520"/>
  <rect width="1200" height="630" fill="url(#glow)"/>
  <rect x="0" y="0" width="1200" height="8" fill="#FF4E00"/>
  ...
  <text x="414" y="368" font-family="Helvetica Neue, Helvetica, Arial, sans-serif" font-size="42" font-weight="500" fill="#cdd9e3">Confidential Agentic Credit</text>
  <text x="414" y="424" font-family="Helvetica Neue, Helvetica, Arial, sans-serif" font-size="29" font-weight="600" letter-spacing="0.5" fill="#FF4E00">Zama FHE · ERC-7984 · Ethereum Sepolia</text>
</svg>`;
